...
namespace ExpressWeb.Controllers
{
    ...
    public class ProhibitedController : BaseController
    {
        ...
        /// </summary>
        [HttpPost]
        public JsonResult Import(HttpPostedFileBase p_prohibited_file)
        {
            var json = new JsonData();
            try
            {
                ...
                if ((p_prohibited_file.ContentLength / 1024 / 1024) > 10)
                {
                    json.Status = false;
                ...
                var fileName = p_prohibited_file.FileName;//文件名
                ...
                p_prohibited_file.SaveAs(Path.Combine(filePath, fileName));
